...
import { View, StyleSheet, Platform, StatusBar, Text, TouchableOpacity, Dimensions, ScrollView } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import Icon from 'react-native-vector-icons/FontAwesome5';
import { useNavigation, useRoute } from '@react-navigation/native';
import { Color } from "../../GlobalStyles";
import DiseaseForm from '../Register/RegisterPatient/DiseaseForm';
import BasicDetails from './RegisterPatient/BasicDetails';
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                {selectedTab === 0 ? 
                    (patientId && <BasicDetails patientId={patientId} />) : 
                    <DiseaseForm patientId={patientId} />
                }
            </ScrollView>
        </SafeAreaView>
    );
