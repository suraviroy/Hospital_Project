...
import { View, Text, Platform,StatusBar,StyleSheet, TouchableOpacity, TextInput, ScrollView, Image, Dimensions , Alert,ActivityIndicator } from 'react-native';
...
const AddPatient = () => {
    ...
    const formattedContactNumber = (countryCode || '+91') + contactNumber;
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <View style={styles.inlineInputContainer}>
                            <View style={[styles.input, styles.countryCodeInput]}>
                                ...
                                key={countryCode ? countryCode : 'countryCode'}
                                placeholder={{
                                    label: 'Select',
                                    value: null,
                                }}
