...
import RequestDetails from '../Request page/RequestDetails'; // Corrected import path
...
const Home = ({ route }) => {
  ...
  const handleViewDetails = () => {
    navigation.navigate('RequestDetails'); // Navigate to 'RequestDetails' screen
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.appointView}>
        ...
        <TouchableOpacity
          ...
          onPress={handleViewDetails} // Update onPress event handler
        >
